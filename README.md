...
Sending broadcast message(with same structure template) more than 5 messages per minute are very risky.
...
4. [Watzap](https://docs.watzap.id/help/connect-to-whatsapp/tips-anti-banned-whatsapp)
